		...
		public function render_content() {
			...
			<label>
				...
				<div class="ap-customize-icons">
					<div class="icontoggler clearfix">
						<div class="selected-icon-preview"><?php if( !empty( $saved_icon_value ) ) { echo '<i class="fa '. esc_attr($saved_icon_value) .'"></i>'; } ?></div><span class="icon-toggler fa fa-arrow-down"></span>
					</div>
