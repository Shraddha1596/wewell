...
function airi_scripts() {
	...
	wp_enqueue_script( 'airi-animate', get_template_directory_uri() . '/js/wow.js', array( 'jquery' ), '20180223', true );

	wp_enqueue_script( 'airi-animate-wow', 'https://cdnjs.cloudflare.com/ajax/libs/wow/1.1.2/wow.min.js', array( 'jquery' ), '20180223', true );
	wp_enqueue_script( 'airi-popper', get_template_directory_uri() . '/js/popper.min.js', array( 'jquery' ), '20180223', true );
	wp_enqueue_script( 'airi-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '20180223', true );
	
	wp_enqueue_script( 'airi-selectjs', get_template_directory_uri() . '/js/jQuery-Multiple-Select-Plugin-For-Bootstrap-Bootstrap-Multiselect/dist/js/bootstrap-multiselect.js', array( 'jquery' ), '20180223', true );
...
function airi_enqueue_bootstrap() {
	...
	wp_enqueue_style( 'airi-bootstrap-style', get_template_directory_uri() . '/css/bootstrap/mdb.min.css' );
	wp_enqueue_style( 'airi-bootstrap-animate', get_template_directory_uri() . '/css/bootstrap/animations-extended.min.css', array(), true );
...
if ( !is_singular()) //if it is not a post or a page
	...
	echo '<meta property="og:title" content=" WeWell: Your Natural Solution to Healthcare - Read Reviews, Join Tribes, Find a Doctor Who Gets You"/>';
	echo '<meta property="og:description" content="WeWell is the healthcare platform that is made for caring. Find integrative, holistic practitioners you love, get insider deals, find answers to whatever ails you and connect with people who share the same health journey as you."/>';
	echo '<meta property="og:type" content="article"/>';
	echo '<meta property="og:url" content="' . get_permalink() . '"/>';
	echo '<meta property="og:site_name" content="WeWell.com"/>';
	
if(!has_post_thumbnail( $post->ID )) { //the post does not have featured image, use a default image
	$default_image="/wp-content/uploads/2019/02/Healthseeker_new.jpg"; //replace this with a default image on your server or an image in your media library
	echo '<meta property="og:image" content="' . get_option('siteurl') .'/wp-content/uploads/2019/02/facebookOg.jpg"/>';
	// echo '<meta property="og:image:width" content="400" />';
	// echo '<meta property="og:image:height" content="400" />';
}
else{
	$thumbnail_src="/wp-content/uploads/2019/02/Healthseeker_new.jpg";
	echo '<meta property="og:image" content="' . get_option('siteurl') .'/wp-content/uploads/2019/02/facebookOg.jpg"/>';
	// echo '<meta property="og:image:width" content="400" />';
	// echo '<meta property="og:image:height" content="400" />';
